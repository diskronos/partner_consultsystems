		...
		<?php endif ?>
			...
			<?php if (Kohana::$config->load('debug_toolbar.panels.modules')): ?>
				<li id="toggle-modules" onclick="debugToolbar.show('debug-modules'); return false;">
					<?php echo html::image(Kohana::$config->load('debug_toolbar.icon_path').'/page_copy.png', array('alt' => 'modules')) ?>
					modules
				</li>
			<?php endif ?>
	...
	<?php if (Kohana::$config->load('debug_toolbar.panels.vars')): ?>
		<div id="debug-vars" class="top" style="display: none;">
			...
			<div style="display: none;" id="vars-post">
				<?php echo isset($_POST) ? Debug::dump($_POST) : Debug::dump(array()) ?>
			</div>
			<div style="display: none;" id="vars-get">
				<?php echo isset($_GET) ? Debug::dump($_GET) : Debug::dump(array()) ?>
			</div>
			<div style="display: none;" id="vars-server">
				<?php echo isset($_SERVER) ? Debug::dump($_SERVER) : Debug::dump(array()) ?>
			</div>
			<div style="display: none;" id="vars-cookie">
				<?php echo isset($_COOKIE) ? Debug::dump($_COOKIE) : Debug::dump(array()) ?>
			</div>
			<div style="display: none;" id="vars-session">
				<?php echo isset($_SESSION) ? Debug::dump($_SESSION) : Debug::dump(array()) ?>
			</div>
		</div>
	<?php endif ?>
